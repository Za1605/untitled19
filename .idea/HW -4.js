...
function exchange(sumUAH, currensyValues, exchangeCurrensy) {
    for (const currensy of  currensyValues) {
        if (currensy.currency === exchangeCurrensy) {
            return sumUAH / currensy.value

        }
    }
}

const zzz = exchange(1000, [{currency:'USD',value:40}, {currency:'EUR',value:42}],'USD');
console.log(zzz);